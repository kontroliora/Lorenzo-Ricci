    ...
    items: [
      {
        ...
        a: "Добавете продукта в количката, попълнете вашите данни (Две имена, Телефон, Адрес на Еконт офис) и потвърдете. Ще се свържем с вас за потвърждение.",
      },
      {
        q: "Как плащам?",
      ...
      },
      {
        ...
        a: "Безплатна доставка за поръчки над €60. За поръчки под €60 - стандартна тарифа на Еконт (от 4.25 € до 5.45 € в зависимост от начина на доставка).",
      },
      {
        q: "Кога ще получа поръчката?",
        a: "Обработваме до 14:00 ч. в работен ден - изпращаме същия ден. Доставка до 2 работни дни с Еконт.",
      },
      {
