...
export const products: Product[] = [
  ...
  // ─── JEWELLERY ───────────────────────────────────────────────────────────────
  {
    ...
    shortDescription: "Ледът, който стъпва тежко",
    description:
      "Хваща светлината от другия край на стаята. Циркониевият кръст блести като лед, но гривната стъпва тежко — усеща се на ръката. Носи я сама или до часовника, за двата пола еднакво.",
    features: [
      "Циркониев кръст, който грее",
      "Регулируема 18+4 см",
      "Унисекс — за него и за нея",
