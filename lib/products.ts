...
export const products: Product[] = [
  ...
  },
  {
    ...
    tabDescription: [
      ...
      "Осезаема тежест на китката, силиконова каишка за комфорт, 5 ATM водоустойчивост. За вечерята, снимката, срещата. Пристига в луксозна кутия, с две години гаранция.",
    ],
    features: [
      "Сапфирен кристал - изключителна яснота и защита от надраскване",
      "Японски кварцов механизъм - прецизен и надежден",
  ...
  },
  {
    ...
    tabDescription: [
      ...
      "Силиконовата каишка ляга удобно, а 5 ATM поемат дъжд, пот и плуване по повърхността. Синьото се съчетава лесно: с деним денем, с тъмно сако вечер. Пристига в луксозна кутия, с две години гаранция.",
    ],
    features: [
      "Сапфирен кристал - изключителна яснота и защита от надраскване",
      "Японски кварцов механизъм - прецизен и надежден",
