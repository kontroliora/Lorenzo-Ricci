...
export const products: Product[] = [
  // ─── WATCHES ────────────────────────────────────────────────────────────────
  {
    ...
    tabDescription: [
      ...
      "Стои еднакво добре под риза и с тениска, а 5 ATM водоустойчивост поемат дъжд и плуване по повърхността. Пристига в луксозна кутия, с две години гаранция.",
    ],
    features: [
  ...
  },
  {
    ...
    tabDescription: [
      ...
      "Осезаема тежест на китката, силиконова каишка за комфорт, 5 ATM водоустойчивост. За вечерята, снимката, срещата — и пристига в луксозна кутия, с две години гаранция.",
    ],
    features: [
      "Сапфирен кристал - изключителна яснота и защита от надраскване",
      "Японски кварцов механизъм - прецизен и надежден",
  ...
  },
  {
    ...
    tabDescription: [
      ...
      "Силиконовата каишка ляга удобно, а 5 ATM поемат дъжд, пот и плуване по повърхността. Синьото се съчетава лесно — с деним денем, с тъмно сако вечер — и пристига в луксозна кутия, с две години гаранция.",
    ],
    features: [
      "Сапфирен кристал - изключителна яснота и защита от надраскване",
      "Японски кварцов механизъм - прецизен и надежден",
  ...
  // ─── JEWELLERY ───────────────────────────────────────────────────────────────
  {
    ...
    features: [
      "Циркониев кръст, който грее",
      "Тънка и лека на ръката",
      "Унисекс — за нея и за него",
      "18K PVD, не избледнява",
    ],
    specs: [
  ...
  },
  {
    ...
    description:
      "Усещаш я в мига, щом щракне. 8 мм плетка, която тежи в ръката и не остава незабелязана — слагаш я до часовника и китката вече говори. Плътно 18K PVD злато, без тънки компромиси.",
    features: [
      "8 мм — тежи в ръката",
      "Масивна плетка, плътно злато",
      "Стои до всеки часовник",
      "Не избледнява",
    ],
    specs: [
      { label: "Материал", value: "316L неръждаема стомана с 18K PVD покритие" },
  ...
  },
  {
    ...
    description:
      "Усуканата плетка върти светлината в спирала при всяко движение. По-фина от масивните, но със същия златен характер — ляга сама или се реди с още. Шест милиметра, които не крещят.",
    features: [
      "Усукана плетка, жива на светло",
      "6 мм — фин, не тежък",
      "Реди се на пластове",
      "18K PVD злато",
    ],
  ...
  },
  {
    ...
    description:
      "Тази, дето не сваляш. Т-закопчалката щраква сигурно, шестте милиметра лягат изчистено под ръкава и стоят с тениска и с риза еднакво. Започваш с нея — и свикваш.",
    features: [
      "Т-закопчалка — щраква сигурно",
      "6 мм под всеки ръкав",
      "С тениска и с риза",
      "Доживотна гаранция",
    ],
    specs: [
  ...
  },
  {
    ...
    description:
      "Кръстът ляга на гърдите и си стои — три милиметра верижка го държи, без да се губи. Дълбоко 18K PVD злато носи духа на стария Рим на днешната улица. 60 см падат точно.",
    features: [
      "Кръст с тежест на гърдите",
      "60 см — пада точно",
      "Дълбоко 18K PVD злато",
      "Хипоалергенна стомана",
    ],
    specs: [
      { label: "Материал", value: "316L неръждаема стомана с 18K PVD покритие" },
  ...
  },
  {
    ...
    description:
      "Осем и половина сантиметра кръст. Не се крие и не се извинява. Grande Imperiale е за онзи, който влиза в стаята пръв — масивен и златен, но чист, не кичозен.",
    features: [
      "8,5 см кръст — доминира",
      "Масивен, но чист",
      "60 см с осанка",
      "18K PVD, не избледнява",
    ],
  ...
  },
  {
    ...
    description:
      "Дебела плетена верига, която тежи на врата и се вижда отдалеч. Чист флекс — злато, което не се преструва на дискретно. На голо или под ризата, знаеш, че е там.",
    features: [
      "Плътна верига, златен флекс",
      "Тежи на врата",
      "На голо или под ризата",
      "18K PVD покритие",
    ],
    specs: [
      { label: "Материал", value: "316L неръждаема стомана с 18K PVD покритие" },
  ...
  },
  {
    ...
    description:
      "Усукана като въже, лъскава като злато. Шест милиметра верига, която лови светлината при всяко движение — за всеки ден, не за случай. 55 см лягат над деколтето, сами или като база под кръст.",
    features: [
      "Усукана верига, жива на светло",
      "55 см — над деколтето",
      "База под висулка",
      "Хипоалергенна 316L",
    ],
